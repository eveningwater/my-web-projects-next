...
import { ComponentPublicInstance, nextTick, onMounted, PropType, toRefs, ref } from 'vue';
...
<template>
    <div class="mini-web-card">
        <div class="mini-web-card-item-front">
            <PreLoadImage :src="getImageURL(directory, cardSourceURL as string)" alt="图片加载中"
                class="mini-web-card-img" />
        </div>
        <div class="mini-web-card-item-behind">
            <card-title level="2" class="mini-web-card-title" :data-title="cardName" ref="titleContainer">{{ (cardIndex!
                + 1) }}.{{ cardName }}</card-title>
