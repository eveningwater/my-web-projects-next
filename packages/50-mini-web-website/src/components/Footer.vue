<template>
    <footer class="mini-web-footer">
        {{ lang === "en" ? "Links:" : "友情链接:" }}
        <a v-for="(link, index) in linkList" :key="link.text + index" :href="link.href" target="_blank"
            rel="noopener noreferrer" class="mini-web-footer-link">{{ link.text }}</a>
    </footer>
</template>
<script lang="ts" setup>
import { PropType, ref, computed, readonly } from 'vue';
